...
export default function EditStaffError({
  error,
  reset,
}: EditStaffErrorProps) {
  useEffect(() => {
      ...
      <section className="overflow-hidden rounded-3xl border border-red-200 bg-white shadow-sm">
        <div className="border-b border-red-200 bg-red-50 p-6 sm:p-8">
          ...
          <h1 className="mt-3 text-3xl font-black tracking-tight text-red-950">
            Staff member could not be edited
          </h1>

          <p className="mt-3 leading-7 text-red-800">
            An unexpected error occurred while loading or saving this staff
            member&apos;s details.
          </p>
        </div>
        ...
        <div className="space-y-6 p-6 sm:p-8">
          <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600">
              Try loading the edit form again. If the problem continues, return
              to the staff list and reopen the staff profile.
            </p>
          </div>
